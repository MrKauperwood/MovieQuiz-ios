...
final class MovieQuizUITests: XCTestCase {
    ...
    func testYesButton() {
        let firstPosterData = getScreenshotForTheImage(withId: idForThePoster)
        app.buttons["Yes"].tap()

        sleep(sleepTime)
        let secondPosterData = getScreenshotForTheImage(withId: idForThePoster)
